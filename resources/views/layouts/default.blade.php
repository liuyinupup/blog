        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                @auth
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('user.create')}}">个人中心</a>
                    </li>
                    @can('admin',auth()->user())
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('user.create')}}">后台</a>
                        </li>
                    @endcan
                @else
                    {{--<li class="nav-item">--}}
                    ...
                    <li class="nav-item">
                        ...
                        <button type="button" class="btn btn-link" data-toggle="modal" data-target="#registerModal" style='color: #222222;'>
                           注册
                        </button>
                        <!-- Modal -->
                    ...
                    <li class="nav-item">
                        <!-- Button trigger modal -->
                        <button type="button" class="btn btn-link" data-toggle="modal" data-target="#loginModal" style='color: #222222;'>
                            登录
                        </button>
                        <!-- Modal -->
